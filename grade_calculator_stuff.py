...
def fsg(semester_grade_1,semester_grade_2, exam_grade,sem_num): # fsg stands for first semester grade.
    if sem_num == 1:
        return ((semester_grade_1*0.8) + (exam_grade*0.2))
    elif sem_num == 2:
        return ((semester_grade_1*0.4) + (semester_grade_2*0.4) + (exam_grade*0.2))
...
if s_num == 1:
    ...
    print(f"Based on previous test grades, your average test grade is a {round(test_grade_average,2)}.")
    print(f"Following this trajectory, your final grade would probably be a {round(fsg(forq_grade,sem_grade_1,test_grade_average,2),2)}.")
    print(f"The maximum final grade you could have in the class would be a {round(fsg(forq_grade,sem_grade_1,100.0,2),2)}.")
    print(f"If you got a 0 on the exam your final grade in the class would be a {round(fsg(forq_grade,sem_grade_1,0,2),2)}.")
